 ...
 const Test =()=>{
    return(
        <>
        <div className="min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-100 rounded-3xl border border-slate-200">
  <div className="text-center max-w-md px-6">
    <div className="w-20 h-20 mx-auto rounded-2xl bg-gradient-to-r from-violet-600 to-fuchsia-600 flex items-center justify-center shadow-lg">
    ...
    <p className="mt-3 text-slate-500 leading-relaxed">
      This page is reserved for testing and developing reusable React
      components. Components under development will appear here.
    </p>

    <div className="mt-8 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-100 text-violet-700 font-medium">
      🚀 Development Mode
    </div>
  </div>
</div>
...
//                                 size="small"
//                                 disabled={isDeleting}
//                                 onClick={() => handleDelete(product._id, product.title || "Product")}
//                                 sx={{
//                                     minWidth: "32px",
//                                     padding: "6px",
//                                     borderColor: "#FCA5A5",
...
//                         icon={XCircle}
//                         label="Requires immediate restock"
//                     /> */}
//                 </div>
